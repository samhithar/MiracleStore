	...
	<div class="check">	 
		<div class="col-md-9 cart-items">
			 <h1>My Shopping Bag</h1>
			     ...
			     <img src=${images.get(status.index)} class="img-responsive" alt=""/></div>
			    
				  <div class="cart-item-info">
				 
				  <h3><a href="#">${cartvalues.getProdname()}</a></h3>
				  ...
				  <ul class="qty">		 
					...
					<form action="Cartupdate" >
						Quantity : <input type="text" name="quantity"  min= "0" max="5" value="${cartvalues.getProdquant()}"/>
		 ...
		 <div class="col-md-3 cart-total">
			 ...
			 <div class="clearfix"></div>
			 <a class="order" href="addressController">Place Order</a>
			 <a class="order" href="/web/Products">Continue Shopping</a>
			</div>
	 </div>
</div>
