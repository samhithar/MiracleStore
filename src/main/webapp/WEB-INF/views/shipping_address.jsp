...
<div id="page-wrapper">
			...
			<div class="typography">
					...
					<form method="get">
						<label for="selector1" class="col-sm-2 control-label">Shipping Address</label>
					...
					<c:forEach items="${addressLine1List}" var="role"> 
					 <c:if test="${role != selected}"> <option value="${role}">${role}</option> </c:if>
					 </c:forEach> </select>
					...
					<input type="submit" id ="editShip" name="editShip" value="edit" disabled="disabled"/>
						
					</form>
					
					<form method="get">
						<label for="selector1" class="col-sm-2 control-label">Billing Address</label>
						<input type="submit" id="editBill" name="editBill" value="edit" disabled/>
					<div class="sign-up2">
			...
			<form action="addressController" method="post">
					...
					<div class="sign-up2">
							...
							<div class="col-sm-8"><%-- <form:select items="${shippingAddressLine1List}" path="billingId.addressLine1" class="form-control1" id="billLine" name="billLine" onchange="showBilling()">
										<input type="submit" value="Edit"/> --%>
										
										
							<input type="hidden" name="shipping1" id="shipping1" />
							<input type="hidden" name="billing1" id="billing1"/>	
...
<form:form action="modifyAddressController" method="post" commandName="address" onsubmit="return check()">
