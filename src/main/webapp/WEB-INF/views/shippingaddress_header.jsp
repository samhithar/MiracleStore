...
function show(){
	...
	xmlHttpRequest.open("Get","AddressListDetails?shipLine="+document.getElementById("shipLine").value,true);
	xmlHttpRequest.send();
	xmlHttpRequest.onreadystatechange=function(){
		if (xmlHttpRequest.readyState == 4 && xmlHttpRequest.status == 200) {
			
			document.getElementById("editShip").disabled=false;
			
			var a = xmlHttpRequest.responseText.split("-");
			  
			  document.getElementById("editShipAddress").value=a[0];			  
			  document.getElementById("ship1").innerHTML = a[1];
			  document.getElementById("ship2").innerHTML = a[2];
			  document.getElementById("ship3").innerHTML = a[3];
			  document.getElementById("ship4").innerHTML = a[4];
			  document.getElementById("ship5").innerHTML = a[5];
			  document.getElementById("shipping1").value=a[1];
...
function showBilling(){
	...
	xmlHttpRequest = new XMLHttpRequest();
	xmlHttpRequest.open("Get","BillingListDetails?billLine="+document.getElementById("billLine").value,true);
	xmlHttpRequest.send();
	xmlHttpRequest.onreadystatechange=function(){
		if (xmlHttpRequest.readyState == 4 && xmlHttpRequest.status == 200) {
			var a = xmlHttpRequest.responseText.split("-");
			document.getElementById("editBill").disabled=false;
			document.getElementById("editBillAddress").value=a[0];
		      
		      document.getElementById("bill1").innerHTML = a[1];
		      document.getElementById("bill2").innerHTML = a[2];
		      document.getElementById("bill3").innerHTML = a[3];
		      document.getElementById("bill4").innerHTML = a[4];
		      document.getElementById("bill5").innerHTML = a[5];
		      document.getElementById("billing1").value = a[1];
            ...
            <div class="navbar-collapse">
				<nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
					<ul class="nav" id="side-menu">
						<li>
							<a href="myaccount.jsp" class="active"><i class="fa fa-home nav_icon"></i>My Account</a>
						</li>
						...
						<li>
							<a href="#" class="chart-nav"><i class="fa fa-bar-chart nav_icon"></i>Address Book</a>
						</li>
						<li>
