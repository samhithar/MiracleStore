...
function populateStates( countryElementId, stateElementId ){
	...
	if(document.getElementById(countryElementId).value == "USA"){
		selectedCountryIndex =239;
	}else{
	...
	var stateElementVal = document.getElementById( stateElementId).value;
	...
	if(s_a[selectedCountryIndex] != ""){
		...
		for (var i=0; i<state_arr.length; i++) {
			...
			if(stateElementVal == state_arr[i]){
...
function populateAllCountries(countryElementId, stateElementId){
...
function populateCountries(countryElementId, stateElementId){
	// given the id of the <select> tag as function argument, it inserts <option> tags
	var selectedVal = document.getElementById(countryElementId).value;
	var countryElement = document.getElementById(countryElementId);
	countryElement.length=0;
	countryElement.options[0] = new Option('Select Country','');
	countryElement.selectedIndex = 0;
